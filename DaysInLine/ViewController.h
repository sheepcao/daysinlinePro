...
@interface ViewController : UIViewController <redrawButtonDelegate,reloadTableDelegate,setMainTextDelegate,ADBannerViewDelegate,UITextFieldDelegate,UIAlertViewDelegate,SKStoreProductViewControllerDelegate>
{
    sqlite3 *dataBase;
